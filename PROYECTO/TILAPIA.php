<?php
// Conexión a la base de datos y obtención de productos de la línea Tilapia
...
$sql_tilapia = "SELECT NOMBRE_PRODUCTO, CODIGO, CATEGORIA, ESTADO, STOCK
                FROM productos
                WHERE LOWER(LINEA) LIKE '%tilapia%'
                ORDER BY NOMBRE_PRODUCTO";
$resultado = $conn->query($sql_tilapia);
?>
...
<head>
  ...
  <title>INVENTARIO - LÍNEA DE TILAPIA</title>
...
<body>
  ...
  <main>
    <section aria-labelledby="titulo-tilapia">
      <h3 id="titulo-tilapia">LÍNEA DE TILAPIA</h3>
