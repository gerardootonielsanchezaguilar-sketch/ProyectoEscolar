<?php
// Conexión a la base de datos y obtención de productos de la línea Cerdos
...
// Buscar cualquier línea que contenga la palabra 'cerdo' (insensible a mayúsculas)
$sql_cerdos = "SELECT NOMBRE_PRODUCTO, CODIGO, CATEGORIA, ESTADO, STOCK
                             FROM productos
                             WHERE LOWER(LINEA) LIKE '%cerdo%'
                             ORDER BY NOMBRE_PRODUCTO";
$resultado = $conn->query($sql_cerdos);
?>
...
<head>
    ...
    <title>INVENTARIO - LÍNEA CERDOS</title>
    <!-- Usar el mismo estilo que GANADO -->
...
<body>
    ...
    <main>
        <section aria-labelledby="titulo-cerdos">
            <h3 id="titulo-cerdos">LÍNEA CERDOS</h3>
