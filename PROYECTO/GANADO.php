<?php
// Conexión a la base de datos y obtención de productos de la línea Ganado Lechero
...
$sql_ganado = "SELECT NOMBRE_PRODUCTO, CODIGO, CATEGORIA, ESTADO, STOCK
                             FROM productos
                             WHERE LINEA = 'Linea de ganado'
                             ORDER BY NOMBRE_PRODUCTO";
$resultado = $conn->query($sql_ganado);
?>
...
<head>
    ...
    <title>INVENTARIO - LÍNEA GANADO LECHERO</title>
...
<body>
    ...
    <main>
        <section aria-labelledby="titulo-ganado">
            <h3 id="titulo-ganado">LÍNEA GANADO LECHERO</h3>
